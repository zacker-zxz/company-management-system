  ...
  return (
    <PageTransition>
      <div className="relative min-h-screen overflow-hidden bg-background">
        ...
        {/* Navigation */}
        <nav className="relative z-10 flex items-center justify-between px-8 py-6 border-b border-primary/10 backdrop-blur-sm bg-white/50">
          <motion.div
        ...
        <section className="relative z-10 min-h-screen flex items-center justify-center px-8 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-slate-700 mb-8 font-light"
            >
        ...
        <section className="relative z-10 px-8 py-20 bg-surface-light/50">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.1 }}
              viewport={{ once: true }}
              className="text-lg text-slate-700 text-center mb-16 max-w-3xl mx-auto"
            >
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <GlassCard key={i} className="text-center hover-glow">
                  ...
                  <h3 className="font-heading text-lg font-bold mb-2 text-slate-800">{feature.title}</h3>
        ...
        {/* Features Section */}
        <section className="relative z-10 px-8 py-20 bg-background">
          <div className="max-w-6xl mx-auto">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-white border border-primary/20 rounded-lg text-slate-700 placeholder-slate-400 focus:outline-none focus:border-primary smooth-transition"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-2 bg-white border border-primary/20 rounded-lg text-slate-700 placeholder-slate-400 focus:outline-none focus:border-primary smooth-transition resize-none"
                    />
                  </div>
        ...
        {/* Footer */}
        <footer className="relative z-10 border-t border-primary/10 px-8 py-8 backdrop-blur-sm bg-white/50">
